...
" DAP Settings are in lua so im enabling lua here
lua <<EOF
...
nnoremap <silent> <leader>s :lua require('dap.ui.widgets').sidebar(require('dap.ui.widgets').scopes).open()<CR>
